...
```text
Environmental interior photography, not pet portraiture: an extra-wide establishing view from the rear corner of a warm fictional independent neighborhood cafe. The camera is eight meters away with a 20mm wide-angle lens. Most of the image shows the cafe architecture and calm atmosphere: a broad expanse of bare wooden floor, large windows, multiple empty tables and chairs framing the foreground, bookshelves, plants, and deep background space. Exactly one adult chow chow dog, chowchow_mascot, with fluffy reddish-brown fur, thick rounded mane, black nose, small triangular ears, and a sturdy compact body rests alone directly on the bare wooden floor in the middle distance, near the lower-left rule-of-thirds point. The wood planks remain clearly visible beneath and immediately around the dog's paws, belly, and body; the dog's fur and paws touch the floor itself. There is no rug, no floor mat, no carpet, no blanket, no cushion, no mattress, and no dog bed anywhere beneath or around the dog. The dog's full body width is less than one third of the image width and the dog occupies roughly 25 percent of the frame; it is clearly smaller than the surrounding cafe furniture, with abundant empty space on every side. No close-up, no pet portrait, no oversized dog. The unobstructed dog has one continuous body and exactly one head, seen in a natural three-quarter side view, lying in a relaxed sphinx pose with two separate parallel front paws, four anatomically correct legs total, and one curled tail. No furniture overlaps the dog. No laptop, no people or human body parts. Warm window daylight, realistic fur and materials, high-angle locked-off wide shot, balanced architecture, no logos, no readable text.
```
