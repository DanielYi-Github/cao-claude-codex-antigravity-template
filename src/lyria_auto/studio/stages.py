...
DEFAULT_KEYFRAME_PROMPT = (
    "Environmental interior photography, not pet portraiture: an extra-wide establishing view of an "
    "intimate late-night jazz cafe and bistro after closing. The camera is eight meters away with a "
    "20mm wide-angle lens. Most of the image shows a sophisticated nocturnal cafe atmosphere: dark "
    "walnut wall panels and bare wooden floor, a long brass-trimmed bar counter with espresso equipment "
    "and glassware, burgundy leather banquettes, small round bistro tables, bentwood chairs, shaded "
    "amber table lamps, vintage brass sconces, and deep cinematic shadows. Tall windows reveal only a "
    "dark rainy night outside with soft blue reflections on the glass; there is no daylight. The "
    "entire establishment is empty except for the single dog. A small upright piano with its keyboard "
    "lid closed, a vintage record player, and abstract geometric jazz artwork suggest quiet music "
    "without musicians, patrons, performers, portraits, or a stage show. No bookshelves, no library, "
    "no reading room. Exactly one adult chow "
    "chow dog, chowchow_mascot, with fluffy reddish-brown fur, thick rounded mane, black nose, small "
    "triangular ears, and a sturdy compact body rests alone directly on the bare wooden floor in the "
    "middle distance, near the lower-left rule-of-thirds point. The wood planks remain clearly visible "
    "beneath and immediately around the dog's paws, belly, and body; the dog's fur and paws touch the "
    "floor itself. There is no rug, floor mat, carpet, blanket, cushion, mattress, or dog bed beneath "
    "or around the dog. The dog's full body width is less than one third of the image width and the dog "
    "occupies roughly 25 percent of the frame, with abundant atmospheric cafe space around it. No "
    "close-up, pet portrait, or oversized dog. The unobstructed dog has one continuous body and exactly "
    "one head, seen in a natural three-quarter side view, lying in a relaxed sphinx pose with two "
    "separate parallel front paws, four anatomically correct legs total, and one curled tail. No "
    "furniture overlaps the dog. No laptop, people, or human body parts. Low-key warm tungsten lighting, "
    "subtle blue night fill, realistic fur and materials, locked-off cinematic wide shot, calm premium "
    "jazz-bistro mood, no logos, no readable text."
)
