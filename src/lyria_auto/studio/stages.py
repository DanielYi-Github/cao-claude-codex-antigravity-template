...
DEFAULT_KEYFRAME_PROMPT = (
    ...
    "atmosphere: a broad expanse of bare wooden floor, large windows, multiple empty tables and chairs "
    ...
    "floor itself. There is no rug, no floor mat, no carpet, no blanket, no cushion, no mattress, and "
    "no dog bed anywhere beneath or around the dog. The dog's full body width is less than one "
    ...
    "close-up, no pet portrait, no oversized dog. The unobstructed dog has one continuous body and "
    "exactly one head, seen in a natural three-quarter side view, lying in a relaxed sphinx pose with two separate parallel front paws, "
